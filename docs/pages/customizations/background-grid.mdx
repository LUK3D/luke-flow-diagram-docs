...
The `LukeFlowCanvas` provides a customizable background grid that can enhance the visual structure of your diagrams.
You can adjust the grid's density, visibility of lines and dots, and colors to fit your application's design.
